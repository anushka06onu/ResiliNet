import pandas as pd
import pytest
from data_pipeline.validate_dataset import validate_telemetry_dataframe
...
def test_validate_telemetry_dataframe_clean():
    ...
    is_valid, violations = validate_telemetry_dataframe(clean_df)
...
def test_validate_telemetry_dataframe_detects_violations():
    ...
    is_valid, violations = validate_telemetry_dataframe(corrupted_df)
...
def test_validate_telemetry_dataframe_sample_real_run():
    ...
    if telemetry_path.exists():
        ...
        is_valid, violations = validate_telemetry_dataframe(df)
