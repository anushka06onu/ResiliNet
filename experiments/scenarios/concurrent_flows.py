...
def run_concurrent_flows():
    ...
    log_experiment_event(results_dir, "congestion_injected_at", {"stage": 2, "delay_ms": 20, "loss_pct": 3})
    s1 = net.get('s1')
    ...
    log_experiment_event(results_dir, "congestion_worsened_at", {"stage": 3, "delay_ms": 35, "loss_pct": 8})
