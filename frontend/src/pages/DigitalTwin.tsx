    ...
    <div className="flex h-full overflow-hidden">
      ...
      <div className="flex-1 relative">
        <div className="absolute top-4 left-4 z-10 pointer-events-none">
          ...
          <p className="text-sm text-slate-300 shadow-black drop-shadow-md">
            Select a node or link to inspect telemetry.
          </p>
        </div>
        ...
        {!selectedElement ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-amber-900/20 border border-amber-500/50 p-3 rounded-lg mt-4">
              <span className="text-xs text-amber-500 font-bold uppercase tracking-widest block mb-1">
                AI Prediction
              </span>
