...
def start_background_flow(net, src_name, dst_name, bw="10M"):
    """
    ...
    print(f"Starting Background Flow: {src_name} -> {dst_name} (Target: {bw}bps)")
    src.cmd(f'iperf -c {dst.IP()} -p 5000 -t 60 &')
